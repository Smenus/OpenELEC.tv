...
cd config
<<<<<<< HEAD
cmake -DUSE_INTERNAL_FFMPEG=off -DENABLE_PYTHON=on -DEXTERNAL_PYTHON_HOME="$SYSROOT_PREFIX/usr" -DCMAKE_LIBRARY_PATH="$SYSROOT_PREFIX/usr/lib" -DCMAKE_PREFIX_PATH="$SYSROOT_PREFIX" -DCMAKE_INCLUDE_PATH="$SYSROOT_PREFIX/usr/include" -DCOMPRESS_TEXTURES=on -DENABLE_AUTOUPDATE=off -DCMAKE_INSTALL_PREFIX=/usr $ROOT/$BUILD/$PKG_NAME-$PKG_VERSION/.
...
>>>>>>> dea625cee85a4d4bd21ba4a2681b76b678e38443
}
